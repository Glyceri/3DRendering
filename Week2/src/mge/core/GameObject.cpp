...
:	_name( pName ), _transform( glm::translate( pPosition ) ), _parent(nullptr), _children(),
    _mesh( nullptr ),_behaviour( nullptr ), _material(nullptr), _world(nullptr), _depthMaterial(new ShadowMaterial())
...
AbstractMaterial* GameObject::getShadowMaterial() const
{
