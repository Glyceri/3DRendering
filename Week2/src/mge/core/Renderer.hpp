...
public:
	 ...
	 */
	void render(World* pWorld, bool renderAsShadow);
	 ...
	 */
	void render(World* pWorld, GameObject* pGameObject, AbstractMaterial* pMaterial, Camera* pCamera, bool pRecursive, bool renderAsShadow);
	 ...
	 * @param pRecursive render everything recursively
	 */
	void render(World* pWorld, GameObject* pGameObject, AbstractMaterial* pMaterial, const glm::mat4& pModelMatrix, const glm::mat4& pViewMatrix, const glm::mat4& pProjectionMatrix, bool pRecursive, bool renderAsShadow);
	...
	* @param pProjectionMatrix the projectionmatrix of the camera
	*/
	void render(World* pWorld, Mesh* pMesh, AbstractMaterial* pMaterial, const glm::mat4& pModelMatrix, const glm::mat4& pViewMatrix, const glm::mat4& pProjectionMatrix, bool renderAsShadow);
...
protected:
	...
	* @param pProjectionMatrix the projectionmatrix of the camera
	*/
	void renderSelf(World* pWorld, GameObject* pGameObject, AbstractMaterial* pMaterial, const glm::mat4& pModelMatrix, const glm::mat4& pViewMatrix, const glm::mat4& pProjectionMatrix, bool renderAsShadow);

	//calls render on each and every child gameobject, material cannot be null!
	void renderChildren(World* pWorld, GameObject* pGameObject, AbstractMaterial* pMaterial, const glm::mat4& pModelMatrix, const glm::mat4& pViewMatrix, const glm::mat4& pProjectionMatrix, bool pRecursive, bool renderAsShadow);
};
